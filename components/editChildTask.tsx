...
import { X, CalendarIcon, ChevronDown, Clock, FileText, Tag, User } from "lucide-react";
            ...
            <div className="bg-white rounded-2xl shadow-2xl max-w-4xl w-full max-h-[95vh] overflow-hidden border border-gray-200">
                ...
                <div className="sticky top-0 bg-gradient-to-r from-green-500 to-green-600 p-6 flex justify-between items-center">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h1 className="text-2xl font-bold text-black">Edit Child Task</h1>
                    ...
                    <div className="space-y-8">
                        ...
                        <div className="space-y-3">
                            ...
                            <input 
                                ...
                                className="w-full p-4 border-2 border-gray-300 rounded-xl focus:border-green-500 focus:ring-4 focus:ring-green-100 transition-all duration-200 text-lg text-black placeholder:text-black"
                            />
                        </div>
                        <div className="space-y-3">
